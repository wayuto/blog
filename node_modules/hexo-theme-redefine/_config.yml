...
home_banner:
  ...
  # Home banner title
  title: Hello world! # Home banner title text
...
navbar:
  ...
  links:
    ...
    About: 
      ...
      submenus:
        Me: /about
        Github: https://github.com/wayuto
        Blog: https://cr0.dpdns.org
    #     Friends: /friends
    # Links: 
...
comment:
  ...
  config:
    ...
    gitalk:
      enable: true # Whether to enable Gitalk
      clientID:  Ov23liwU1MtE3E2lqI13  # GitHub Application Client ID
      clientSecret: ebd3ccbde1134c894487dd200db0341389d3f0e9 # GitHub Application Client Secret
      repo: blog # GitHub repository
      owner: wayuto # GitHub repository owner
      label: Gitalk # GitHub issue label
    ...
    giscus:
      repo: wayuto/blog # Github repository name e.g. EvanNotFound/hexo-theme-redefine
      repo_id: R_kgDOPPlyXA # Github repository id
      category: General # Github discussion category
      category_id: DIC_kwDOPPlyXM4CtM3A # Github discussion category id
